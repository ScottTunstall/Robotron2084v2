    ...
    static int Main(string[] args)
    {
        ...
        (string Name, int Off, int W, int H, byte[]? Inline)[] extras =
        {
            ...
            ("ProgBurst", 0, 6, 16, new byte[]
            {
                ...
                0xAA,0x0B, 0xB0,0xBB, 0x00,0xAA, 0x00,0x00,
                0xAA,0x0B, 0xB0,0xBB, 0x00,0xAA, 0x00,0x00,
                0xAA,0x0B, 0xB0,0xBB, 0x00,0xAA, 0x00,0x00,
                0xAA,0x00, 0x00,0x00, 0x00,0xAA, 0x00,0x00,
                0xAA,0xAA, 0xA0,0xAA, 0xAA,0xA0,
                0xAA,0xA0, 0x00,0x00, 0xAA,0xA0,
                0xAA,0x00, 0x00,0x00, 0x00,0xAA, 0x00,0x00,
                0xAA,0x0A, 0x00,0x0A, 0x00,0xAA, 0x00,0x00,
                0xAA,0x0A, 0x00,0x0A, 0x00,0xAA, 0x00,0x00,
                0xAA,0xAA, 0x0A,0x0A, 0xAA,0xA0,
                0xAA,0xAA, 0x0A,0x0A, 0xAA,0xA0,
                0xAA,0xAA, 0x0A,0x0A, 0xAA,0xA0,
                0xAA,0x00, 0x0A,0x00, 0x00,0xAA, 0x00,0x00,
                0xAA,0xAA, 0xAA,0xAA, 0xAA,0xA0,
            }),
        };
